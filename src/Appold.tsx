...
// import { Leaf, DollarSign, BatteryCharging, Phone, X, Calculator, Smile } from 'lucide-react';
// import BannerImg from "./assets/img/banner.jpg";
// import SideBanner from "./assets/img/side_banner.jpg"

// // Custom CSS for animations and fonts. Tailwind doesn't have these by default.
// const customStyles = `
...
// // Utility component for animating elements on scroll.
...
//   return (
//     <div
//       className={`transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'} ${isVisible ? `slide-in-up` : ''}`}
...
//       <div className="bg-white p-8 rounded-3xl shadow-2xl max-w-lg w-full relative transform scale-100 transition-transform duration-300">
...
//   const handleCallNow = () => {
//     // In a real app, this would trigger a phone call, e.g., window.location.href = 'tel:+1234567890';
//     setShowCallMessage(true);
//     setTimeout(() => setShowCallMessage(false), 5000); // Hide message after 5 seconds
//   };
